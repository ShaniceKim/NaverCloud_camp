  ...
  <div class="container relative-box "> <a class="navbar-brand" href="#">BitSalon</a>
    ...
    <div class="navbar-toggleable-md collapse" id="exCollapsingNavbar2" >
      <ul class="nav navbar-nav pull-xs-right">
        ...
        <li class="nav-item"> <a class="nav-link" href='/member/list.jsp'>회원</a></li>
        <li class="nav-item"> <a class="nav-link" href='/board/list.jsp?category=1'>후기</a></li>
        <li class="nav-item"> <a class="nav-link" href='/reserve/add'>예약</a></li>
        <li class="nav-item"> <a class="nav-link" href='/board/list.jsp?category=2'>Contact Us</a> </li>
      </ul>
    </div>
  </div>
</nav>
